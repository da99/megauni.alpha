...
BEGIN
  ...
  CASE SPLITS
  WHEN ARRAY['FOLLOW', 'SCREEN_NAME', 'SCREEN_NAME']::VARCHAR[] THEN
    SPLITS := ARRAY['FOLLOW', 'SCREEN_NAME', 'SCREEN_NAME', 'SCREEN_NAME']::VARCHAR[];

  WHEN ARRAY['LINK', 'CARD', 'SCREEN_NAME']::VARCHAR[] THEN
    SPLITS := ARRAY['LINK', 'SCREEN_NAME', 'CARD', 'SCREEN_NAME']::VARCHAR[];
  ELSE
    NAME := NAME;
  END CASE;
